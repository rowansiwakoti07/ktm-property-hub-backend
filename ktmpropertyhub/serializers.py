...
class PropertyListingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'district', 'local_area', 'price_min', 'price_max', 'price_negotiable',
            'land_size_1_value', 'land_size_1_unit', 'land_size_2_value', 'land_size_2_unit',
            'road_size_min_ft', 'road_size_max_ft', 'road_condition', 'facing_direction',
            'land_type', 'property_condition', 'built_year_bs', 'built_year_ad',
            'floors_min', 'floors_max', 'master_bedrooms_min', 'master_bedrooms_max',
            'common_bedrooms_min', 'common_bedrooms_max', 'common_bathrooms_min',
            'common_bathrooms_max', 'living_rooms_min', 'living_rooms_max',
            'kitchens_min', 'kitchens_max', 'has_laundry', 'has_store',
            'has_puja_room', 'furnishing', 'parking_car_min', 'parking_car_max',
            'parking_bike_min', 'parking_bike_max', 'rent_duration_value',
